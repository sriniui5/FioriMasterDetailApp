sap.ui.define([
		...
		return BaseObject.extend("my.root.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias my.root.model.ListSelector
			 */
			 ...
			 * @return {my.root.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
